...
<div class="spacer-xs"></div>
        ...
        <p>Besonders möchten wir uns hier bei Nicolas Pyschny und Sebastian Goldschmidtböing bedanken, die uns mit überrragender Expertise und Motivation in allen Lagen zur Seite gestanden haben und uns die Arbeit an diesem Thema ermöglicht haben.</p>
<div class="spacer-xs"></div>
    ...
    case "Zwischenpräsentation":
      ...
      files = [
        ...
        { name: "Tisch Fahrradständer CAD-Datei", file: "FUSION14_Tischplatte.zip", image: "INT3.jpg" },
         { name: "QR-Ralley Handout", file: "FUSION14_QR-Ralley.pdf", image: "INT6.png" },
      ];
